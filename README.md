...
**【律动】** 锁定技，你的回合内，当有角色使用与上一张被使用的有色牌颜色不同的牌时，其摸一张牌，然后你弃置其一张牌。
...
**【成韵】** 转换技，锁定技，当有角色于其回合内使用与上一张牌押韵的牌时，阴/阳：你交给/获得其一张牌，你/其摸一张牌。

**【论章】** 你获得过牌的回合结束时，你可重铸至多等量张牌并可与一名角色拼点，若你赢，你可视为对其使用一张你本回合失去过的牌。
<br>
<br>
...
**【舞圣】** 当你每回合首次使用一种牌名字数的牌时，你可将手牌摸/弃至此牌牌名字数并与一名其他角色各弃/摸一张牌，本回合你使用牌可指定其为额外目标且其不可响应。

**【请休】** 锁定技，结束阶段，你亮出牌堆顶X张牌，直至你下回合开始，花色包含于其中的牌对你无效，若X为：
2：你失去一点体力；
3：你翻面。
（X为你本回合弃置牌的花色数-1）
