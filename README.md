...
**【成韵】** 转换技，当有角色于其回合内使用与上一张牌押韵的牌时，阴/阳：你/其可交给其/你一张牌并摸一张牌。
...
**【舞圣】** 当你每回合首次使用一种牌名字数的牌时，你可将手牌摸/弃至此牌牌名字数并与一名其他角色各弃/摸一张牌，然后可令此牌对其额外结算一次。

**【请休】** 锁定技，结束阶段，你摸X张牌，弃X张牌，直至你下回合开始，花色包含于其中的单目标牌对你无效，若X为：
2：你失去一点体力；
3：你翻面。
（X为你本回合弃置牌的花色数-1）
